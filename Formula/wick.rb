class Wick < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/wickproject/wick/releases/download/v0.10.0/wick-darwin-arm64.tar.gz"
      sha256 "5f8bc1dfd5897f31c526efe9d4898497f3bce6dacdb729764de35ca6bdba3f30"
    end
  end
